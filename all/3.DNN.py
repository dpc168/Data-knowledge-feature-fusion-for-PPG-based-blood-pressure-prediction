...
for current_dir in sorted_dir:
    ...
    for run in range(10):
        ...
        X_train, X_test, y_train, y_test = train_test_split(
            X_tensor.cpu(), y_tensor.cpu(), test_size=0.2,
            random_state=np.random.randint(100))  # Different random seeds
...
# 保存到result.xlsx文件
final_results_df.to_excel('result3.xlsx', index=False)

print("\n" + "=" * 50)
print("所有结果已保存到 result3.xlsx 文件")
print("=" * 50)
